...
<div class="container mt-5">
    ...
    <form action="/submit" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="CourseName" placeholder="Enter Your Course Name" name="name" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Batch" placeholder="Enter Your Batch" name="Batch" required>
        </div>
        <div class="form-group">
            <label for="calendar">Date Of Survey:</label>
            <input type="date" class="form-control" id="calendar" placeholder="Enter Date Of Survey" name="calendar" required>
        </div>
        <div class="form-group">
